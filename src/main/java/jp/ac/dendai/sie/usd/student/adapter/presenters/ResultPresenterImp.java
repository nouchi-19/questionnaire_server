...
//        Map<Long, List<Answer>> answerListMap = answerList.stream().collect(Collectors.groupingBy(Answer::getResultId));
        ...
        return resultMapper.toRes(result, questionnaireMapper.toRes(questionnaire, subject, questionResList, resultList), answerResList);
    }
...
//            }
            ...
            resultResList.add(resultMapper.toRes(result, questionnaireMapper.toRes(questionnaire, subject, questionResList, resultList1), answerResList));
        }
