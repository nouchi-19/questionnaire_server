...
public interface QuestionnaireMapper {
    Questionnaire toDomain(Long subjectId, QuestionnaireReq questionnaireReq);
    QuestionnaireRes toRes(Questionnaire questionnaire, Subject subject, List<QuestionRes> questionResList);
}