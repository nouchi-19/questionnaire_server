...
import jp.ac.dendai.sie.usd.teacher.adapter.controllers.ResultController;
...
//    public Response postResults(@QueryParam("subjectId")Long subjectId, @PathParam("questionnaireId")Long questionnaireId, ResultReq resultReq) {
